                  ...
                  <div className='inputsdellogin'>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-12 bg-white/10 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/30 transition-all duration-200 text-white placeholder-white placeholder-opacity-100 backdrop-blur-sm"
